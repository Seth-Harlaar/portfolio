...
export const skillData = {
  ...
  skills: [
    {
      img:  require('../../images/icons/code0.png'),
    ...
    {
      img:  require('../../images/icons/react1.png'),
      title: 'React.js',
    ...
    {
      img:  require('../../images/icons/node1.png'),
      title: 'Node.js',
      shortDesc:  'Node.js is the backbone of many server-side web applications.',
      longDesc:   'It is also used for this website (your looking at the static version though), along with a GPS data analytics site I built during my Software Systems Development and Integration course at UofG.',
    },
 
    {
      img:  require('../../images/icons/math1.png'),
      title: 'Math',
    ...
    {
      img:  require('../../images/icons/oop0.png'),
      title: 'OOP',
    ...
    {
      img:  require('../../images/icons/flutter2.png'),
      title: 'Flutter',
